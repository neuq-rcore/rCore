...
impl Ext4FileSystem {
    ...
    pub fn new(device_id: usize) -> FileSystem<Ext4IO, NullTimeProvider, LossyOemCpConverter> {
...
unsafe impl Send for Ext4IO {}
unsafe impl Sync for Ext4IO {}
